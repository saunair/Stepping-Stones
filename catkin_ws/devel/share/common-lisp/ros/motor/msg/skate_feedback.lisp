...
;//! \htmlinclude skate_feedback.msg.html

(cl:defclass <skate_feedback> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass skate_feedback (<skate_feedback>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <skate_feedback>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'skate_feedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor-msg:<skate_feedback> is deprecated: use motor-msg:skate_feedback instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <skate_feedback>))
...
(cl:defmethod force_front_outer-val ((m <skate_feedback>))
...
(cl:defmethod force_front_inner-val ((m <skate_feedback>))
...
(cl:defmethod force_rear-val ((m <skate_feedback>))
...
(cl:defmethod imu_quat_x-val ((m <skate_feedback>))
...
(cl:defmethod imu_quat_y-val ((m <skate_feedback>))
...
(cl:defmethod imu_quat_z-val ((m <skate_feedback>))
...
(cl:defmethod imu_quat_w-val ((m <skate_feedback>))
...
(cl:defmethod imu_accel_x-val ((m <skate_feedback>))
...
(cl:defmethod imu_accel_y-val ((m <skate_feedback>))
...
(cl:defmethod imu_accel_z-val ((m <skate_feedback>))
...
(cl:defmethod imu_rate_x-val ((m <skate_feedback>))
...
(cl:defmethod imu_rate_y-val ((m <skate_feedback>))
...
(cl:defmethod imu_rate_z-val ((m <skate_feedback>))
...
(cl:defmethod velocity_cmd_rear-val ((m <skate_feedback>))
...
(cl:defmethod velocity_cmd_front-val ((m <skate_feedback>))
...
(cl:defmethod skate_fault-val ((m <skate_feedback>))
...
(cl:defmethod position_filt_rear-val ((m <skate_feedback>))
...
(cl:defmethod position_filt_front-val ((m <skate_feedback>))
...
(cl:defmethod velocity_filt_rear-val ((m <skate_feedback>))
...
(cl:defmethod velocity_filt_front-val ((m <skate_feedback>))
...
(cl:defmethod dead_man_enable-val ((m <skate_feedback>))
...
(cl:defmethod controller_target-val ((m <skate_feedback>))
...
(cl:defmethod skate_mode-val ((m <skate_feedback>))
  ...
  (skate_mode m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <skate_feedback>) ostream)
  "Serializes a message object of type '<skate_feedback>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <skate_feedback>) istream)
  "Deserializes a message object of type '<skate_feedback>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<skate_feedback>)))
  "Returns string type for a message object of type '<skate_feedback>"
  "motor/skate_feedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skate_feedback)))
  "Returns string type for a message object of type 'skate_feedback"
  "motor/skate_feedback")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<skate_feedback>)))
  "Returns md5sum for a message object of type '<skate_feedback>"
  "4fcef49017325db1881c7de732fff139")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'skate_feedback)))
  "Returns md5sum for a message object of type 'skate_feedback"
  "4fcef49017325db1881c7de732fff139")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<skate_feedback>)))
  "Returns full string definition for message of type '<skate_feedback>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'skate_feedback)))
  "Returns full string definition for message of type 'skate_feedback"
  (cl:format cl:nil "Header header~%int16 force_front_outer~%int16 force_front_inner~%int16 force_rear~%float32 imu_quat_x~%float32 imu_quat_y~%float32 imu_quat_z~%float32 imu_quat_w~%float32 imu_accel_x~%float32 imu_accel_y~%float32 imu_accel_z~%float32 imu_rate_x~%float32 imu_rate_y ~%float32 imu_rate_z~%float32 velocity_cmd_rear~%float32 velocity_cmd_front~%uint8 skate_fault~%float32 position_filt_rear~%float32 position_filt_front~%float32 velocity_filt_rear~%float32 velocity_filt_front~%bool dead_man_enable~%float32 controller_target~%byte skate_mode~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <skate_feedback>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <skate_feedback>))
  "Converts a ROS message object to a list"
  (cl:list 'skate_feedback
