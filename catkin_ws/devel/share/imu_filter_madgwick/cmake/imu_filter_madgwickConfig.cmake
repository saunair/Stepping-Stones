...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /home/saurabh/catkin_ws/src/imu_tools/imu_filter_madgwick)
  set(imu_filter_madgwick_DEVEL_PREFIX /home/saurabh/catkin_ws/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /home/saurabh/catkin_ws/install)
...
if(NOT "/home/saurabh/catkin_ws/devel/include;/usr/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/home/saurabh/catkin_ws/devel/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Martin Günther <martin.guenther1980@gmail.com>, Ivan Dryanovski <ivan.dryanovski@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saurabh/catkin_ws/src/imu_tools/imu_filter_madgwick/${idir}'.  Ask the maintainer 'Martin Günther <martin.guenther1980@gmail.com>, Ivan Dryanovski <ivan.dryanovski@gmail.com>' to fix it.")
    endif()
    _list_append_unique(imu_filter_madgwick_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "imu_filter;imu_filter_nodelet;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_signals.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${imu_filter_madgwick_dep}_FOUND)
      find_package(${imu_filter_madgwick_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${imu_filter_madgwick_dep} REQUIRED ${depend_list})
  endif()
